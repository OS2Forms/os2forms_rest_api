...
* Upgraded actions.
* Added `drupal/webform_node_element` to Drupal lenient allow list.
* Added `ergebnis/composer-normalize` as dev requirement.
* Allowed `simplesamlphp/composer-xmlprovider-installer` composer plugin.
